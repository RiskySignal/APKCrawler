...
ADD COLUMN `update_date` datetime NULL COMMENT '更新日期' AFTER `sdk_level`;

ALTER TABLE `apk_merge`.`authority`
MODIFY COLUMN `authority_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '权限名称' AFTER `authority_id`;

ALTER TABLE `apk_merge`.`link`
MODIFY COLUMN `href` varchar(1023) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '网址' AFTER `link_id`;
